    ...
    <section class="content">
        ...
        <div>
            ...
            <div class="box-header">
                 ...
                 <a href='<?php echo site_url('User/get_country_wise_called_data_Hot/'.$country.''); ?>'>Back</a>
                  </div>
                    ...
                    <td><?php echo $r['Company_Contact']; ?></td>
                       ...
                       <td><?php echo $r['Next_Call_Date']; ?></td>
                        <td><?php echo $r['Equiv_our_date']; ?></td>
                                            ...
                                            {
                                                ?>
                                                 <a class="btn btn-success" href="<?php echo site_url('User/Hot_Data_Call_Client_date/'. $r['Prospect_Icode'].''); ?>" > <i class="glyphicon glyphicon-zoom-in icon-white"></i> Call
            </a>
