      ...
      <div class="row">
        ...
        <div class="col-md-8">
         <div class="box box-primary">
           ...
           <h4 style="background-color: #f5d4c2;"><?php
          if($key['Prospect_Status'] =='Hot')
          {
            ?> HOT Followup Call
            <?php
          }
          else if($key['Prospect_Status'] =='Warm')
          {
            ?>
            Warm Followup Call
            <?php
          ...
          ?></h4>
            ...
            ?>
              ...
              <div class="col-md-1">
            <a data-toggle="modal" data-target="#myModal5"    >Other</a>
            </div>
            </div>
            ...
            <div class="col-md-4">
               ...
               <div class="form-group">
                ...
                <input type="hidden" name="prospect_Icode"  value="<?php echo $key['Prospect_Icode'];  ?>">
                 ...
                 <input  type="radio" id="ptype" name="Prospect_Status" <?php echo ($key['Prospect_Status'] =='Cold')?'checked':'' ?> value="Cold" >Cold
                 <input  type="radio" id="ptype" name="Prospect_Status" <?php echo ($key['Prospect_Status'] =='Warm')?'checked':'' ?> value="Warm">Warm
                 <input  type="radio" id="ptype"  name="Prospect_Status" <?php echo ($key['Prospect_Status'] =='Hot')?'checked':'' ?> value="Hot">Hot
  ...
  <label>Meeting Type</label>
        <div class="form-group">
                  ...
                  <select name="mtype" class="form-control" id="mtype" required >
                     <option value="1" >General Call</option>
                ...
                <div class="box-body" >
                  ...
                  <div class="direct-chat-messages" >
                    ...
                    <div class="direct-chat-msg">
                      ...
                      <!-- /.direct-chat-img -->
                      <div class="direct-chat-text">
                      <a data-toggle="modal" data-target="#myModal6" onclick="meeting_history(<?php echo $key['Meeting_Status_Icode'] ?>)" > <i class="glyphicon glyphicon-eye-open"></i>...</a>
...
<div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width: 60%;">
        <div class="modal-content" >
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                 <h4 class="modal-title" id="myModalLabel">Data Team Assessment</h4>
...
alert("Please Fill Result & Comments");
        ...
        else
        {
          ...
          $.ajax({  
                         url:"<?php echo site_url('User/Followup_Data_Call_status_client_date'); ?>",  
                        data: {prospect_Icode: pcode,Prospect_Status: status,Check: ncall,equal_our_date: our_date,Result: call,Comment: cmmd,client_date:client_date,Scheduled_date: scheduled,Meeting: mtype  },  
                        type: "POST",  
                        cache: false,
                        success:function(data){ 
                          if(data == 1)
...
$(document).ready(function(){
  ...
  $(".show-read-more").each(function(){
    ...
    if($.trim(myStr).length > maxLength){
      ...
      $(this).append(' <a class="read-more" data-toggle="modal" data-target="#myModal6"  >...</a>');
